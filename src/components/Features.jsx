      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
            Unlock Your <span className="text-teal-400">Travel Potential</span>
          </h2>
          <p className="text-xl text-gray-600">
            Experience travel and adventure like never before with our exclusive
            features and services that redefine your travel experience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative bg-white rounded-full shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-4 hover:shadow-2xl"
            >
