      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
            Popular <span className="text-teal-400">Destinations</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {selectedActivities.map((activity) => (
            <div
              key={activity.id}
              className="group relative bg-white rounded-4xl shadow-md overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg border border-gray-200"
            >
              ...
              <div className="p-6 flex flex-col justify-between">
                <h3 className="text-lg font-semibold text-gray-500 mb-4 line-clamp-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link to={`/activity`}>
                    <button className="group flex items-center text-blue-600 hover:text-teal-800 transition-colors">
                      Explore Now
