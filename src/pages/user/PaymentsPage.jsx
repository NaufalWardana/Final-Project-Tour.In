...
import { Upload, X, CircleCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto flex flex-col gap-8">
          {/* Ringkasan Aktivitas */}
          <div className="bg-white rounded-4xl shadow-lg p-8 mt-8 transition-all hover:shadow-xl">
            <h2 className="text-center text-xl font-bold mb-6 text-gray-900">
              Activity Summary
            </h2>
          ...
          <div className="bg-gray-50 rounded-4xl shadow-lg p-8 transition-all hover:shadow-xl">
            <h2 className="text-center text-xl font-bold mb-6 text-gray-900">
              Upload Proof of Payment
            </h2>
            <div className="border-4 border-dashed border-gray-300 rounded-full p-8 text-center hover:border-teal-400 transition-colors">
              <input
                type="file"
            ...
            {proofImage && (
              <button
                ...
                className=" mt-6 w-full px-20 py-3 bg-teal-500 text-white rounded-full font-medium hover:bg-teal-600 transition-colors"
              >
                Upload Image
              </button>
            )}
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-full shadow-lg p-8 transition-all hover:shadow-xl w-full max-w-md text-center">
            <CircleCheck className="w-16 h-16 text-green-500 mx-auto mb-4" />
            <h2 className="text-2xl font-bold mb-4 text-gray-900">
              Bukti Pembayaran Berhasil Diunggah!
            </h2>
            <p className="text-gray-600 mb-6">
              Pembayaran anda telah berhasil diunggah. Anda akan diarahkan ke
              halaman Mytransaksi.
            </p>
            <button
              onClick={() => navigate("/transactions")}
              className="w-auto px-6 py-3 bg-teal-400 text-white rounded-xl font-medium hover:bg-blue-700 transition-colors"
            >
              My Transactions
            </button>
          </div>
