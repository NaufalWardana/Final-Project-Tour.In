...
const ActivityCard = ({ activity }) => {
  ...
  return (
    <div className="bg-white rounded-4xl shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300 flex flex-col h-full">
      {/* Image Section */}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex-grow">
          ...
          <div className="flex items-center font-semibold gap-4 mb-4 text-sm text-gray-600">
            <div className="flex items-center">
              <Users className="w-4 h-4 mr-1" />
              <span>{activity.total_reviews} Activity Reviews</span>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600">
              Chose your destination for your next adventure
            </p>
          </div>
