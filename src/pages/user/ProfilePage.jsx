  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-teal-400  rounded-full p-8 mb-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:ml-auto flex gap-4">
              <button
                ...
                className="px-6 py-3 bg-blue-500/40 hover:bg-blue-500/70 text-white rounded-2xl flex items-center gap-2 transition"
              >
              ...
              <button
                ...
                className="px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-2xl flex items-center gap-2 transition"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-4xl p-6 shadow-sm h-fit">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="p-3 bg-blue-50 rounded-full">
                  <UserPen className="w-5 h-5 text-teal-400" />
                </div>
                <div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold">History Transactions</h2>
                <button
