  ...
  return (
    <div className="min-h-screen w-full bg-gray-900 flex">
      ...
      <div className={`w-full p-4 ${isExpanded ? "ml-64" : "pl-14"}`}>
        {/* Header section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Management Activity</h1>
          <p className="text-gray-400">Manage all activity here.</p>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center overflow-y-auto">
            <div className="bg-gray-800 p-6 rounded-lg w-full max-w-lg max-h-[90%] overflow-y-auto">
              <h2 className="text-xl font-bold text-white mb-4">
                {formData.id ? "Edit Aktivitas" : "Add Activity"}
              </h2>
